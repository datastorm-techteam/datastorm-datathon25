...
const Main = () => {
  return (
    <div class="bg-red-950 border-x-2 border-yellow-600 shadow-2xl px-[1rem] lg:px-[5rem] flex flex-col items-center justify-center h-auto min-h-[100vh] gap-5 max-w-[80vw] lg:max-w-[70vw] mx-auto pt-20">
