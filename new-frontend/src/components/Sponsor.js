...
const Sponsor = () => {
  return (
    <div class="overflow-x-hidden bg-stone-950 border-x-2 border-yellow-600 shadow-2xl px-[1rem] lg:p-[5rem] flex flex-col items-center justify-center h-auto gap-5 max-w-[80vw] lg:max-w-[70vw] mx-auto pt-20">
